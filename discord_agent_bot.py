...
# Use a single-worker executor to offload disk I/O while guaranteeing FIFO order
...
def save_histories():
    try:
        # Convert keys to strings for JSON serialization and serialize on the main thread
        ...
        logger.error(f"Error preparing chat histories for saving: {e}")
